...
<head>
<title>Quai des savoirs-faire</title>
    ...
    <section class="team-section section-gap-full" id="quoi-partager">
        <div class="container">
            <div class="section-title">
                <h1 class="text-center">Quoi partager ?</h1>
                <p class="text-center">Des savoir-faire professionnels et personnels.</p>
            </div>
            <div class="row">
                        ...
                        <div class="owl-stage" style="transform: translate3d(-3802px, 0px, 0px); transition: all 2s ease 0s; width: 5558px;">
                            <div class="owl-item cloned" style="width: 262.5px; margin-right: 30px;">
                                <div class="single-team item">
                                    ...
                                    <h3>Excel</h3><br>
                                    <p>Comment faire pour réaliser ou concevoir un tableau croisé dynamique ?</p>
                                </div>
                            </div>
                            <div class="owl-item cloned" style="width: 262.5px; margin-right: 30px;">
                                <div class="single-team item">
                                    ...
                                    <h3>Couture</h3><br>
                                    <p>Je propose de montrer comment faire un sac à tarte.
                            ...
                            <div class="owl-item cloned" style="width: 262.5px; margin-right: 30px;">
                                <div class="single-team item">
                                    ...
                                    <h3>Sport</h3><br>
                                    <p>Je débute la course et j'aimerai être guidé et le faire en groupe.</p>
                                </div>
                            </div>
                            <div class="owl-item cloned" style="width: 262.5px; margin-right: 30px;">
                                <div class="single-team item">
                                    <img alt="" class="img-fluid" src="img/categories_bureautique.png"><br>
                                    <h3>Outils bureautiques</h3><br>
                                    <p>Je veux savoir mettre mes messages Outlook en couleur.</p>
                                </div>
                            </div>
                            <div class="owl-item cloned" style="width: 262.5px; margin-right: 30px;">
                                <div class="single-team item">
                                    <img alt="" class="img-fluid" src="img/categories_bureautique.png"><br>
                                    <h3>Généalogie</h3><br>
                                    <p>Je propose de vous aider à débuter une recherche généalogique</p>
                                </div>
                            </div>
                            <div class="owl-item cloned" style="width: 262.5px; margin-right: 30px;">
                                <div class="single-team item">
                                    <img alt="" class="img-fluid" src="img/categories_animation.png"><br>
                                    <h3>Parler en public</h3><br>
                                    <p>Je vous propose une méthode pour préaprer un pitch et parler en public</p>
                                </div>
                            </div>
                        </div>
...
<section class="background-main-section section-gap-full" id="quoi-partager">
    ...
    <ul class="timeline">
        ...
        <li>
          <div class="timeline-badge"><i class="glyphicon glyphicon-check">2</i></div>
          <div class="timeline-panel">
            <div class="timeline-heading">
        ...
        <li class="timeline-inverted">
          <div class="timeline-badge"><i class="glyphicon glyphicon-check">3</i></div>
          <div class="timeline-panel">
            <div class="timeline-heading">                        
